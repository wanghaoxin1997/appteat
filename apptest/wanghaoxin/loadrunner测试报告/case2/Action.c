Action()
{
	...
	web_submit_data("edit_2", 
		...
		"Name=CaseInfoView[product_id]", "Value={n}", ENDITEM, 
		"Name=isPageDirty", "Value={n1}", ENDITEM, 
		...
		"Name=CaseInfoView[assign_to_name]", "Value={a}", ENDITEM, 
		"Name=CaseInfoView[mail_to]", "Value={b},", ENDITEM, 
		"Name=CaseInfoView[priority]", "Value=1", ENDITEM, 
		"Name=Custom[CaseType]", "Value={c}", ENDITEM, 
		"Name=Custom[CaseMethod]", "Value={d}��", ENDITEM, 
		"Name=Custom[CasePlan]", "Value={e}", ENDITEM, 
		"Name=Custom[ScriptStatus]", "Value={f}", ENDITEM, 
		"Name=Custom[ScriptedBy]", "Value={g}", ENDITEM, 
		"Name=Custom[ScriptedDate]", "Value={data}", ENDITEM, 
	...
	web_url("case", 
		"URL=http://10.7.90.40:8033/bugfree3/index.php/case/3", 
		"TargetFrame=_blank", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=", 
	...
	web_url("getPreNextId", 
		"URL=http://10.7.90.40:8033/bugfree3/index.php/search/getPreNextId?id=3&type=case&product_id=1", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.7.90.40:8033/bugfree3/index.php/case/3", 
		"Snapshot=t9.inf", 
		"Mode=HTML", 
		LAST);
	...
	lr_end_transaction("case2", LR_AUTO);
